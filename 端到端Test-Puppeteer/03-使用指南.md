...
Puppeteer 中的所有默认配置都可以通过两种方式进行自定义：
...
| downloadBaseUrl                 | string                      | 指定下载浏览器的前缀地址，不同的浏览器产品对应的下载路径不同：<br />https://storage.googleapis.com/chrome-for-testing-public or https://archive.mozilla.org/pub/firefox/nightly/latest-mozilla-central, |
